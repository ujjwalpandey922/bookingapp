...
const Hotel = () => {
  ...
  const { data, loading, error, reFetch } = useFetch(
    `${BackendAddress}api/hotels/find/${param.id}`
  );
  ...
  return (
    <div>
      ...
      {loading ? (
        ...
        <div className="hotelContainer">
          ...
          <div className="hotelWrapper">
            ...
            <button className="booking" onClick={handleReserve}>
              BOOK NOW
            </button>
            ...
            <div className="hotelDetails">
              ...
              <div className="hotelDetailsPrice">
                ...
                <h2>
                  <b>₹{data.cheapestPrice * days * state.personInfo.room}</b> (
                  {days} nights)
                </h2>
      ...
      {openModal && <Reserve setOpenModal={setOpenModal} hotelId={param.id} />}
    </div>
  );
};
