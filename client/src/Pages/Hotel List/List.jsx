...
const List = () => {
 ...
 const {data,loading,error,reFetch} = useFetch(`http://localhost:5000/api/hotels?city=${destination}&min=${min || 0}&max=${max||10000}`);
    const handleSearch =()=>{
      reFetch();
    }
  return <>
          ...
          <div className="listWrapper">
            <div className="listSearch">
              ...
              <div className="listSearchItem">
                ...
                <span onClick={()=>setOpenData(!openData)}>{`${format(dates[0].startDate,"dd/MM/yyy")} to ${format(dates[0].endDate,"dd/MM/yyy")}`}</span>
              </div>
             {openData && <DateRange
               ...
               <div className="listSearchItem">
                ...
                <div className="listSearchItemPadding">
                  ...
                  <div className="listOptionItem">
                    <span className="listOptionText">Min Price <small>per nigth</small></span>
                    <input type="text" className="listOptionInput" onChange={(e)=>setMin(e.target.value)}/>
                  </div>
                  <div className="listOptionItem">
                    <span className="listOptionText">Max Price <small>per nigth</small></span>
                    <input type="text"  className="listOptionInput" onChange={(e)=>setMax(e.target.value)} />
                  </div>
                  <div className="listOptionItem">
